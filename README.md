...
MS-Picker is a software tool implemented for detecting peaks from metabolomics datasets generated by the LC-MS/MS platform. MS-Point is a cross-platform command-line tool that applies logistic regression using nine quality metrics to generate a quality score for each detected peak.
